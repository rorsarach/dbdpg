...

{
    ...
    use version; our $VERSION = qv('3.20.3');
...
This documents version 3.20.3 of the DBD::Pg module
...
B<'DBD::Pg ping test v3.20.3'>. It returns 0 (false) if the connection is not valid,
